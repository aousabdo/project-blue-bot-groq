...
nest_asyncio.apply()
st.set_page_config(
    page_title="Project Blue Bot",
    page_icon=":flying_saucer:",
)
st.title(":flying_saucer: Project Blue Bot :alien:")
st.markdown("##### :alien: The Truth is Out There: Project Blue Bot's Cosmic Knowledge Vault :rocket: ")
st.markdown("Dive into a universe of classified intel! Our AI has devoured declassified UFO reports and top-secret documents from the shadowy corners of the US government. From the dusty shelves of the National Archives to the encrypted files of the CIA, DIA, and FBI - we've got it all. Ready to explore the extraordinary?")
...
def main() -> None:
    # Get LLM model
    llm_model = st.sidebar.selectbox("Select LLM", options=["llama-3.1-70b-versatile", "llama3-70b-8192", "llama3-8b-8192"])
